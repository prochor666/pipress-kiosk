<template>
    ...
    <main class="p-0 m-0 text-center">
        ...
        <div class="w-full h-screen max-h-screen min-h-screen font-sans text-base p-2 md:p-4 lg:p-6">
            ...
            <!-- <div class="px-1 py-2 md:py-8 lg:py-12" v-if="data.offline === false && data.media.files.length > 0">
                <Media :media="data.media" :lang="data.lang" :key="hashes.media" />
            </div> -->

            <div class="px-1 py-4 md:py-8 lg:py-12" v-if="data.offline === true">
                <Offline />
            </div>
